...
//+kubebuilder:rbac:groups=operatorfwk.felipe88alves,resources=products,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=operatorfwk.felipe88alves,resources=products/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=operatorfwk.felipe88alves,resources=products/finalizers,verbs=update
